...
class CustomerServicePage extends StatefulWidget {
  static String tag = 'customer_service';
  final String host;
  CustomerServicePage({required this.host});

  @override
  _CustomerServiceState createState() => _CustomerServiceState();
}

class _CustomerServiceState extends State<CustomerServicePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(CustomerServicePage.tag +
